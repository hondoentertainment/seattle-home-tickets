export const UNOFFICIAL_ESTIMATE_LINE =
  "Unofficial mid-tier quantity estimates, not quotes or live inventory.";

export const NO_TICKET_SALES_LINE =
  "This site does not sell tickets, take orders, or handle refunds.";
